    ...
    return (
       <div className="bg-gray-300 min-h-screen flex flex-col justify-center items-center font-display xl:flex xl:flex-row xl:justify-center">
            ...
            <div className="bg-white shadow-xl flex flex-col items-center p-10 gap-5">
                ...
                <div className='text-center width-componentes md:w-2xl xl:w-lg'>
                    <h2 className='text-2xl text-gray-500 font-semibold xl:text-lg'>
                        Não se preocupe, não contaremos a ninguém.
                    </h2>
                </div>
                <div className='bg-gray-100 width-componentes h-15 md:w-2xl xl:w-lg xl:h-12 '>
                    <input type="email" name="" id="" placeholder='E-mail' className='h-full w-full md:w-full xl:w-full xl:h-full p-5 font-black uppercase'/>
                </div>
