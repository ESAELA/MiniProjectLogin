...
function Login () {
    return (
        <div className="bg-gray-300 min-h-screen items-center justify-center flex h-screen w-screen">
            ...
            <div className="bg-white p-20 max-w-md md:px-80 rounded-sm shadow-xl flex flex-col items-center font-display">
                <div className="w-92 flex flex-col gap-7 items-center ">
                    ...
                    <div className=' p-2 px-4 py-4 mt-3 rounded-4xl cursor-pointer border-2 border-gray-300 transition duration-300 ease-in-out hover:-translate-y-1'>
                        <Icon path={mdiArrowRight} size={2} />
                    </div>
                    <div className='flex flex-col items-center gap-2 text-gray-500 text-sm font-extrabold uppercase'>
